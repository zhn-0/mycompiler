...
static const yytype_int16 yyrline[] =
{
     ...
     109,   110,   113,   116,   123,   130,   139,   146,   153,   162,
     169,   176,   185,   192,   199,   208,   217,   234,   241,   250,
     257,   266,   273,   282,   289,   298,   305,   312,   319,   326,
     333,   340,   347,   354,   361,   370,   377,   384,   391,   398,
     405,   412,   421,   424,   427,   435,   436
};
#endif
...
{
  "$end", "error", "$undefined", "ADD", "SUB", "MUL", "DIV", "TST", "STO",
  "LOD", "JMP", "JEZ", "JLZ", "JGZ", "DBN", "DBS", "OUT", "NOP", "END",
  "INTEGER", "REG", "LABEL", "','", "':'", "'+'", "'-'", "'('", "')'",
  "$accept", "start", "program", "statement", "nop_stmt", "add_stmt",
  "sub_stmt", "mul_stmt", "div_stmt", "tst_stmt", "lab_stmt", "jmp_stmt",
  "jez_stmt", "jlz_stmt", "jgz_stmt", "lod_stmt", "sto_stmt", "out_stmt",
  "end_stmt", "dbn_stmt", "dbs_stmt", YY_NULLPTR
};
#endif
